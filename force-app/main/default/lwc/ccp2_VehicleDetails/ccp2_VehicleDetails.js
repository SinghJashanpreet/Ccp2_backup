    ...
    if (data) {
      ...
      if (data.length != 0) {
        let obj = {
          ...
          vehicleBrand:
            data[0].vehicleBrandName__c == undefined
              ? "null"
              : data[0].vehicleBrandName__c,
          type: data[0].type__c == undefined ? "null" : data[0].type__c,
          registerYear:
            data[0].Registration_Year__c == undefined
              ? "null"
              : data[0].Registration_Year__c,
          mileage:
            data[0].mileage__c == undefined ? "null" : data[0].mileage__c,
          vinNumber:
            data[0].chassisNumberVIN__c == undefined
              ? "null"
              : data[0].chassisNumberVIN__c,
          carFormat:
            data[0].CarModelFormatName__c == undefined
              ? "null"
              : data[0].CarModelFormatName__c,
          lastDate:
            data[0].lastArrivalDateTime__c == undefined
              ? "null"
              : data[0].lastArrivalDateTime__c,
          bodymaker:
            data[0].BodyMakerNo__c == undefined
              ? "null"
              : data[0].BodyMakerNo__c,
          bodyShape:
            data[0].bodyShape__c == undefined ? "null" : data[0].bodyShape__c,
          initialDate:
            data[0].DatefronInitialRegistrationDate__c == undefined
              ? "null"
              : data[0].DatefronInitialRegistrationDate__c,
          initialRegistrationDate:
            data[0].initialRegistrationOfJapaneseCalender__c == undefined
              ? "null"
              : data[0].initialRegistrationOfJapaneseCalender__c
        };
