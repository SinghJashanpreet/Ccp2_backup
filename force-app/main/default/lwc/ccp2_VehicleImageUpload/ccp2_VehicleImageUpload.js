...
export default class Ccp2_VehicleImageUpload extends LightningElement {
  ...
  scrollToTop() {
    const scrollerDiv = this.template.querySelector('#image-container');
    console.log('scrollerDiv',scrollerDiv);
    console.log('scrollerDiv tem',JSON.stringify(this.template.querySelectorAll('.upload-main')));
    if (scrollerDiv) {
        scrollerDiv.scrollTo(0, 0);
    }
}
