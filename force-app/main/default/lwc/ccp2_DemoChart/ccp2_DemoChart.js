...
export default class VehicleServiceTimeline extends LightningElement {
  ...
  @api base64Pdf; // Base64 PDF data passed to the component

  get vfPageUrl() {
    // Encode the base64 string to ensure it's URL-safe
    const encodedPdfData = encodeURIComponent(this.base64Pdf);
    // Construct the URL to the Visualforce page
    return `/apex/RenderPdfPage?pdfData=${encodedPdfData}`;
  }
}
